  ...
  const embeds = [
    {
      ...
      fields: [
        ...
        { name: "Guests", value: data.guests && data.guests !== "" ? data.guests : "0", inline: true },
        { name: "Subscribe", value: data.subscribe ? "Yes" : "No", inline: true },
        { name: "Notes", value: data.notes || "N/A", inline: false },
      ],
