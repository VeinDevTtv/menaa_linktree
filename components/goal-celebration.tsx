    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          {/* Modern 3D Soccer ball confetti */}
          {Array.from({ length: 15 }).map((_, i) => (
            ...
            >
              <div 
                className="w-3 h-3 rounded-full relative overflow-hidden shadow-lg"
                style={{
                  background: `
              ...
              >
                ...
                <div className="absolute inset-0">
                  ...
                  />
                  <div 
                    className="absolute top-1/4 left-1/4 w-0.5 h-0.5 rounded-full"
                    style={{
                ...
                {/* Mini highlight */}
                <div 
                  className="absolute top-0.5 left-0.5 w-1 h-1 rounded-full blur-sm opacity-50"
                  style={{
